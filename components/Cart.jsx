  ...
  return (
    <div className="cart-wrapper" ref={cartRef}>
      <div className="cart-container">
        ...
        data-text="Awesome" id="closeModalButton" className="button closeModalButton" onclick="closeModal()" onDoubleClick="hideButtons" 
        >
        ...
        <span id="cart-num-items" className="cart-num-items">
            <h3 > 
