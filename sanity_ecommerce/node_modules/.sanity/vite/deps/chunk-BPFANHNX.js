import {
  ...
  useValidationStatus,
  v4_default
} from "./chunk-C2CFSAQW.js";
import {
  require_jsx_runtime
} from "./chunk-WEWQ6CIH.js";
import {
  __commonJS,
  __toESM,
  require_react
} from "./chunk-QLD5OB2C.js";
...
var require_Component = __commonJS({
  "../node_modules/react-copy-to-clipboard/lib/Component.js"(exports) {
    ...
    var _excluded7 = ["text", "onCopy", "options", "children"];
    ...
    var CopyToClipboard2 = function(_React$PureComponent) {
      ...
      _createClass(CopyToClipboard3, [{
        ...
        value: function render() {
          var _this$props2 = this.props, _text = _this$props2.text, _onCopy = _this$props2.onCopy, _options = _this$props2.options, children = _this$props2.children, props = _objectWithoutProperties2(_this$props2, _excluded7);
          var elem = _react["default"].Children.only(children);
...
// ../node_modules/sanity/lib/_chunks/desk-e211a9df.esm.js
...
var _excluded = ["childId", "childPayload", "childParameters"];
var _excluded2 = ["documentId", "documentType", "parentRefPath", "children", "template"];
var _excluded3 = ["params", "payload"];
var _excluded4 = ["children", "currentMinWidth", "currentMaxWidth", "flex", "id", "minWidth", "maxWidth", "selected"];
var _excluded5 = ["as", "children", "overflow", "padding"];
var _excluded6 = ["intent"];
...
var getVisiblePoll$ = () => {
  if (!visiblePoll$) {
    visiblePoll$ = fromEvent(document, "visibilitychange").pipe(startWith(null), map(() => document.visibilityState === "visible"), distinctUntilChanged(), switchMap((visible) => visible ? timer(0, POLL_INTERVAL) : EMPTY), shareReplay({
      refCount: true,
      bufferSize: 1
    }));
  }
...
function PaneItemPreview(props) {
  ...
  return (0, import_jsx_runtime.jsx)(SanityDefaultPreview, _objectSpread(_objectSpread({}, getPreviewValueWithFallback({
    value,
    draft,
    published
  })), {}, {
...
var BackLink = (0, import_react.forwardRef)(function BackLink2(props, ref) {
  ...
  return (0, import_jsx_runtime.jsx)(StateLink, _objectSpread(_objectSpread({}, props), {}, {
    ref,
    state: state2
  }));
});
var ChildLink = (0, import_react.forwardRef)(function ChildLink2(props, ref) {
  ...
  return (0, import_jsx_runtime.jsx)(StateLink, _objectSpread(_objectSpread({}, rest), {}, {
    ref,
    state: {
...
var ReferenceChildLink = (0, import_react.forwardRef)(function ReferenceChildLink2(_ref6, ref) {
  let {
    ...
    children,
    template
  } = _ref6, rest = _objectWithoutProperties(_ref6, _excluded2);
  return (0, import_jsx_runtime.jsx)(ChildLink, _objectSpread(_objectSpread({}, rest), {}, {
    ref,
    childId: documentId,
    childPayload: template == null ? void 0 : template.params,
    childParameters: _objectSpread({
      type: documentType,
...
var ParameterizedLink = (0, import_react.forwardRef)(function ParameterizedLink2(props, ref) {
  ...
  const {
    params,
    payload
  } = props, rest = _objectWithoutProperties(props, _excluded3);
  const nextParams = useUnique(params);
  const nextPayload = useUnique(payload);
  const nextState = (0, import_react.useMemo)(() => {
    const currentGroup = currentPanes[groupIndex];
    const currentSibling = currentGroup[siblingIndex];
    const nextSibling = _objectSpread(_objectSpread({}, currentSibling), {}, {
  ...
  return (0, import_jsx_runtime.jsx)(StateLink, _objectSpread(_objectSpread({
    ref
  }, rest), {}, {
    state: nextState
  }));
...
function ReferencePreviewLink(props) {
  ...
  const Link = (0, import_react.useCallback)(function LinkComponent(linkProps) {
    return (0, import_jsx_runtime.jsx)(ReferenceChildLink3, _objectSpread({
...
function ConfirmDeleteDialogBody(_ref10) {
  ...
  if ((internalReferences == null ? void 0 : internalReferences.totalCount) === 0 && (crossDatasetReferences == null ? void 0 : crossDatasetReferences.totalCount) === 0) {
    return (0, import_jsx_runtime.jsxs)(Text, {
      as: "p",
      children: ["Are you sure you want to delete ", (0, import_jsx_runtime.jsxs)("strong", {
      ...
      children: (0, import_jsx_runtime.jsxs)(Flex, {
        ...
        children: [internalReferences.totalCount > 0 && (0, import_jsx_runtime.jsxs)(Stack, {
          ...
          children: [internalReferences == null ? void 0 : internalReferences.references.map((item) => (0, import_jsx_runtime.jsx)(Box, {
            ...
            as: "li",
            padding: 3,
            children: (0, import_jsx_runtime.jsx)(OtherReferenceCount, _objectSpread({}, internalReferences))
          })]
          ...
          children: [(0, import_jsx_runtime.jsx)(CrossDatasetReferencesSummary, {
            ...
            children: [(0, import_jsx_runtime.jsxs)(Table, {
              ...
              padding: 2,
              children: (0, import_jsx_runtime.jsx)(OtherReferenceCount, _objectSpread({}, crossDatasetReferences))
            })]
          })]
        })]
      })
...
function ConfirmDeleteDialogContainer(props) {
  ...
  return error ? (0, import_jsx_runtime.jsx)(Dialog, {
    ...
    onCatch: setError,
    children: (0, import_jsx_runtime.jsx)(ConfirmDeleteDialog, _objectSpread({}, props))
  });
}
...
function PaneContextMenuButton(props) {
  ...
  return (0, import_jsx_runtime.jsx)(MenuButton, {
    ...
    menu: (0, import_jsx_runtime.jsx)(Menu, {
      children: groups.map((group, groupIndex) => (0, import_jsx_runtime.jsxs)(import_react.Fragment, {
...
function PaneContextMenuItem(props) {
  ...
  const IntentButtonOrActionButton = (0, import_react.forwardRef)((linkProps, linkRef) => item.intent ? (0, import_jsx_runtime.jsx)(IntentLink, _objectSpread(_objectSpread({}, linkProps), {}, {
    intent: item.intent.type,
    params: item.intent.params,
    ref: linkRef
  })) : (0, import_jsx_runtime.jsx)("button", _objectSpread({
    type: "button"
  }, linkProps)));
...
var Pane = (0, import_react.forwardRef)(function Pane2(props, ref) {
  ...
  const {
    ...
    selected = false
  } = props, restProps = _objectWithoutProperties(props, _excluded4);
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [(0, import_jsx_runtime.jsx)(LegacyLayerProvider, {
      ...
      children: (0, import_jsx_runtime.jsx)(PaneContext.Provider, {
        value: contextValue,
        children: (0, import_jsx_runtime.jsxs)(Root$4, _objectSpread(_objectSpread({
          "data-testid": "pane",
          tone: "inherit",
          hidden,
          id,
...
var PaneContent = (0, import_react.forwardRef)(function PaneContent2(props, ref) {
  const {
    ...
    overflow,
    padding
  } = props, restProps = _objectWithoutProperties(props, _excluded5);
  const {
    collapsed
  } = usePane();
  const {
  ...
  return (0, import_jsx_runtime.jsx)(Root$3, _objectSpread(_objectSpread({
      ...
      children: (0, import_jsx_runtime.jsx)(LegacyLayerProvider, {
        ...
        children: (0, import_jsx_runtime.jsxs)(Card, {
          ...
          children: [(0, import_jsx_runtime.jsxs)(Layout, {
            ...
            sizing: "border",
            style: layoutStyle,
            children: [backButton, (0, import_jsx_runtime.jsxs)(TitleBox, {
              flex: 1,
            ...
            }), subActions && (0, import_jsx_runtime.jsx)(Box, {
              children: subActions
            })]
          })]
        })
...
var IntentButton = (0, import_react.forwardRef)(function IntentButton2(props, ref) {
  const {
    intent
  } = props, restProps = _objectWithoutProperties(props, _excluded6);
  const Link = (0, import_react.useMemo)(() => (0, import_react.forwardRef)(function Link2(linkProps, linkRef) {
    return (0, import_jsx_runtime.jsx)(IntentLink, _objectSpread(_objectSpread({}, linkProps), {}, {
      intent: intent.type,
      params: intent.params,
      ref: linkRef
    }));
  }), [intent]);
  return props.disabled ? (0, import_jsx_runtime.jsx)(Button, _objectSpread(_objectSpread({}, props), {}, {
    as: "a",
    role: "link",
    "aria-disabled": "true"
  })) : (0, import_jsx_runtime.jsx)(Button, _objectSpread(_objectSpread({}, restProps), {}, {
    as: Link,
    "data-as": "a",
    ref
  }));
  ...
  return (0, import_jsx_runtime.jsx)(MenuButton, {
    ...
    menu: (0, import_jsx_runtime.jsxs)(Menu, {
      children: [(0, import_jsx_runtime.jsx)(Box, {
        ...
        if (!template || !intent)
          return null;
        const Link = (0, import_react.forwardRef)((linkProps, linkRef) => disabled ? (0, import_jsx_runtime.jsx)("button", _objectSpread(_objectSpread({
          type: "button",
          disabled: true
        }, linkProps), {}, {
          ref: linkRef
        })) : (0, import_jsx_runtime.jsx)(IntentLink, _objectSpread(_objectSpread({}, linkProps), {}, {
          intent: intent.type,
          params: intent.params,
          ref: linkRef
        })));
...
var PaneHeaderActions = (0, import_react.memo)((_ref19) => {
  ...
  return (0, import_jsx_runtime.jsx)(Inline, {
    space: 1,
    children: [Boolean(combinedInitialValueTemplates.length) && (0, import_jsx_runtime.jsx)(PaneHeaderCreateButton, {
      templateItems: combinedInitialValueTemplates
    }, "$CreateMenuButton"), ...actionMenuItems.map((actionItem, actionIndex) => {
      return (0, import_jsx_runtime.jsx)(Tooltip, {
        content: (0, import_jsx_runtime.jsx)(Box, {
          padding: 2,
          children: (0, import_jsx_runtime.jsx)(Text, {
...
var router = route.create("/", [route.intents("/intent"), route.create("/edit/:type/:editDocumentId", [route.create({
  path: "/:params",
  transform: {
    params: {
...
function parsePanesSegment(str) {
  ...
  return str.split(";").map((group) => {
    ...
    return [firstSibling, ...restOfSiblings.map((sibling) => _objectSpread(_objectSpread(_objectSpread({}, firstSibling), sibling), {}, {
      ...
      params: _objectSpread(_objectSpread({}, (0, import_omit.default)(firstSibling.params, exclusiveParams)), sibling.params),
...
var deskTool = definePlugin((options) => ({
  ...
  tools: [{
    ...
    component: (0, import_react.lazy)(() => import("./index-71beeb8c.esm-OWRAN72X.js").then(function(n) {
      return n.i;
    })),
...
var ComponentViewBuilder = class extends GenericViewBuilder {
  constructor(componentOrSpec) {
    const spec = isComponentSpec(componentOrSpec) ? _objectSpread({}, componentOrSpec) : {
      options: {}
    };
    super();
    this.spec = spec;
...
var DocumentBuilder = class {
  ...
  clone() {
    ...
    const options = _objectSpread(_objectSpread({}, this.spec.options || {}), withSpec.options || {});
...
function inferInitialValueTemplates(context, spec) {
  ...
  return typeNames.flatMap((schemaType) => document2.resolveNewDocumentOptions({
    type: "structure",
    schemaType
  })).map((option) => _objectSpread(_objectSpread({}, option), {}, {
    icon: ComposeIcon
  }));
}
...
function getDocumentTypeList(context, typeNameOrSpec) {
  ...
  return new DocumentTypeListBuilder(context).id(spec.id || typeName).title(spec.title || title).filter("_type == $type").params({
    ...
    schemaType: typeName,
    documentId
  }))).canHandleIntent(spec.canHandleIntent || defaultIntentChecker).menuItems(spec.menuItems || [...getOrderingMenuItemsForSchemaType(context, type), new MenuItemBuilder(context).group("layout").title("Compact view").icon(StackCompactIcon).action("setLayout").params({
    layout: "default"
...
function createStructureBuilder(_ref33) {
  ...
  const context = _objectSpread(_objectSpread({}, source), {}, {
    ...
    resolveDocumentNode: (options) => {
      let builder = (defaultDocumentNode == null ? void 0 : defaultDocumentNode(structureBuilder, _objectSpread(_objectSpread({}, options), configContext))) || new DocumentBuilder(context);
      if (!builder.getId()) {
...
function DeskToolProvider(_ref34) {
  ...
  const rootPaneNode = (0, import_react.useMemo)(() => {
    if (resolveStructure)
      return resolveStructure(S, _objectSpread(_objectSpread({}, configContext), {}, {
        documentStore
      }));
    return S.defaults();
...
//# sourceMappingURL=chunk-BPFANHNX.js.map
